...
export default function CtaBanner() {
  return (
    <section className="w-full bg-primary text-primary-foreground border-b border-border relative overflow-hidden py-16 md:py-24 px-4 sm:px-6 md:px-8">
      {/* Subtle Grid / Texture */}
      ...
      >
        ...
        <h2 className="text-2xl sm:text-3xl lg:text-4xl xl:text-5xl font-extrabold tracking-tight leading-[1.18] text-white">
