          ...
          >
            ...
            <div className="px-5 py-4 border-b border-border/70 flex items-center justify-between bg-muted/20 shrink-0">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  <h2 className="text-base font-bold text-foreground tracking-tight">Sửa bài học Shadowing</h2>
                  <p className="text-xs text-muted-foreground">Cập nhật thông tin video và phụ đề đồng bộ.</p>
                </div>
              </div>
              <button
                onClick={onClose}
            ...
            <div className="p-5 space-y-4 overflow-y-auto flex-1">
              ...
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-muted/40 border border-border rounded-xl px-3.5 py-2.5 pr-10 text-xs font-mono text-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all"
                    ...
                    >
                      {isFetchingTranscript ? (
                        ...
                        <>
                          ...
                          <span>Tự động tải lại phụ đề từ YouTube</span>
                        </>
                      )}
                    </button>
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-muted/40 border border-border rounded-xl px-3.5 py-2 text-xs text-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all h-18 resize-none leading-relaxed"
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  className="w-full bg-muted/40 border border-border rounded-xl px-3.5 py-2 text-xs font-mono text-foreground focus:outline-none focus:border-primary focus:ring-2 focus:ring-primary/20 transition-all h-36 resize-none leading-relaxed"
